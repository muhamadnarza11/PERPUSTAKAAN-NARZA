...
<body>
                    ...
                    <div class="kotak-login p-5">
                        ...
                        <form action="" method="post">
                            <div class="form-group mt-5 mb-5">
                                ...
                                <input class="form-control" type="text" id="nama" name="nama" placeholder="username" 
    ...
    include('koneksi.php');
        if (isset($_POST['login'])) {
            ...
            $query = mysqli_query($konek,"SELECT * FROM petugas WHERE nama = '$nama' && password = '$password'");
